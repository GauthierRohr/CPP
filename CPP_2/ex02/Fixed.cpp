...
// COMPARAISON
// pas besoin de convertir en float car la multiplication ne change pas le résultat pour une comparaison
//
...
// ARITHMETIQUE
// Obligé de convertir en float car besoin d'un résultat réel, pas un bool
//
